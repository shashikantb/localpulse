...
const PostComposer: FC<PostComposerProps> = ({ sessionUser, onPostSuccess }) => {
  ...
  const handleAddPost = async (content: string, hashtags: string[], is_family_post: boolean, mediaUrls?: string[], mediaType?: 'image' | 'video' | 'gallery', mentionedUserIds?: number[]) => {
