...
const BusinessCard: FC<BusinessCardProps> = ({ business, userLocation }) => {
  ...
  return (
    <Link href={`/users/${business.id}`} className="block transition-transform hover:-translate-y-1">
        <Card className="shadow-lg hover:shadow-primary/20 transition-shadow duration-300 h-full cursor-pointer">
        <CardHeader>
            ...
            <div className="flex flex-col gap-2 w-full sm:w-auto">
                ...
                <a href={`tel:${business.mobilenumber}`} onClick={(e) => e.stopPropagation()}>
