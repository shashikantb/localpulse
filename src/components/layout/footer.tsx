...
import { Users, CalendarDays, Code } from 'lucide-react';
...
const Footer: FC = () => {
  ...
  return (
    <footer className="py-8 text-center text-sm text-muted-foreground bg-gradient-to-t from-background to-muted/20 border-t border-border/70 shadow-inner mt-auto">
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-8 mb-4 text-base">
          {isLoadingCounts ? (
            <>
